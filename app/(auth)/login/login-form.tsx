...
interface Props {
  /**
   * Dipulangkan dari /dashboard karena sesi valid tapi baris `profiles` tidak
   * ada. Dibaca di server lewat searchParams, bukan useSearchParams() di sini:
   * hook itu memaksa seluruh form dibungkus <Suspense> sehingga HTML halaman
   * login terkirim kosong dan formnya baru muncul setelah JavaScript dimuat.
   */
  tanpaProfil: boolean
}

export function LoginForm({ tanpaProfil }: Props) {
